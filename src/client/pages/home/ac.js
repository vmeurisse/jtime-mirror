class AC {
   ...
   * @param {function} config.datasource - the datasource to use. The method get as parameter the query string and should
   *                                       return a promise to an array of suggestions
   ...
   * @param {int} offset - the number of positions between the curent active suggestion and the new one
   * @private
   */
  shiftActive(offset) {
   ...
   * @param {int} index - The index of the suggestion to activate
   * @param {boolean} [autoScroll] - If `true` the list will be scrolled so that the suggestion is visible
   * @private
   */
   ...
   * @param {int} index - the index of the selection to select
   * @private
   */
  select(index) {
